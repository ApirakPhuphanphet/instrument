...
export class MaintenanceService {
    ...
    async sendToMaintenance(data) {
        ...
        if (instrument.status === 'borrowed') {
            throw new MaintenanceServiceError('Instrument is currently borrowed. Please return it before sending to maintenance.', 400);
        }
        ...
        if (activeMaintenance) {
            throw new MaintenanceServiceError('An active in-progress maintenance record already exists for this instrument.', 409);
        }
    ...
    async returnFromMaintenance(id, data = {}) {
        ...
        if (maintenance.status !== 'in_progress') {
            throw new MaintenanceServiceError(`Cannot return instrument: maintenance is already marked as '${maintenance.status}'.`, 400);
        }
