...
export type InstrumentGroupResponse = z.infer<typeof InstrumentGroupResponseSchema>;
...
export type CreateInstrumentGroupInput = z.infer<typeof CreateInstrumentGroupSchema>;
...
export type UpdateInstrumentGroupInput = z.infer<typeof UpdateInstrumentGroupSchema>;

export const InstrumentGroupParamsSchema = z.object({
  id: z.string().uuid('Invalid group UUID format')
});

export type InstrumentGroupParamsInput = z.infer<typeof InstrumentGroupParamsSchema>;
...
export type InstrumentGroupQueryInput = z.infer<typeof InstrumentGroupQuerySchema>;
...
export type DeleteInstrumentGroupQueryInput = z.infer<typeof DeleteInstrumentGroupQuerySchema>;
